...
- **Objective:** Ski as far as possible without colliding with obstacles. Survive until 500m to trigger the Yeti chase sequence.
- **Controls:**
  - **W** — Slow down
  - **S** — Speed up
  - **A** — Steer left
  - **D** — Steer right
  - 🎮 **Gamepad (Switch Pro Controller, Xbox, PlayStation, USB):**
    - **Left stick up / D-pad up** — Slow down
    - **Left stick down / D-pad down** — Speed up
    - **Left stick left/right / D-pad left/right** — Steer left/right
    - Acceleration scales with stick deflection for smooth speed control
...
- **The Yeti:** After skiing 500m, a Yeti appears and begins chasing the player. It accelerates as it gets closer and can navigate around obstacles. Collision with the Yeti ends the game.
...
2. Connect a gamepad (Xbox, PlayStation, Switch Pro, or standard USB controller) — optional.
3. Click **Start Skiing** to begin.
4. Use **W/S** to control speed and **A/D** to steer, or use your gamepad's left stick or D-pad for all controls.
5. Avoid obstacles and try to survive as long as possible!
